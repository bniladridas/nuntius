...
class CliTest < Minitest::Test
  def test_help_shows_usage
    stdout, _stderr, status = Open3.capture3("bundle exec ruby bin/nuntius help")
  ...
  def test_help_with_no_args
    stdout, _stderr, status = Open3.capture3("bundle exec ruby bin/nuntius")
  ...
  def test_generate_without_prompt_error
    stdout, _stderr, status = Open3.capture3("bundle exec ruby bin/nuntius generate")
  ...
  def test_unknown_command_error
    stdout, _stderr, status = Open3.capture3("bundle exec ruby bin/nuntius unknowncmd")
